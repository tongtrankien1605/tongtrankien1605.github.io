...
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? (module.exports = e()) : "function" == typeof define && define.amd ? define("uikit", e) : ((t = t || self).bdtUIkit = e());
})(this, function () {
    "use strict";
    ...
    var Ht = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, menuitem: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 };
    function Lt(t) {
        return V(t).some(function (t) {
    ...
    function le(s, a) {
        return new se(function (t, e) {
            ...
            Yt(n, "load", function () {
                0 === n.status || (200 <= n.status && n.status < 300) || 304 === n.status ? t(n) : e(G(Error(n.statusText), { xhr: n, status: n.status }));
            }),
                Yt(n, "error", function () {
    ...
    function fe(t) {
        if ("loading" === document.readyState)
            var e = Yt(document, "DOMContentLoaded", function () {
                e(), t();
            });
        else t();
    }
    ...
    function Ye(t) {
        ...
        if (!ut) return Re(e).getPropertyValue("--bdt-" + t);
        if (!(t in Ue)) {
            var i = we(e, document.createElement("div"));
            ze(i, "bdt-" + t), (Ue[t] = qe(i, "content", ":before").replace(/^["'](.*)["']$/, "$1")), ke(i);
        }
        return Ue[t];
    }
    var Xe = {};
                    ...
                    return new se(function (i, n) {
                        ...
                        Gt(
                            ...
                            function (t) {
                                ...
                                clearTimeout(r),
                                    De(o, "bdt-transition"),
                                    Ve(o, { transitionProperty: "", transitionDuration: "", transitionTimingFunction: "" }),
                                    ("transitioncanceled" === e ? n : i)();
                            },
                            { self: !0 }
                        ),
                            ze(o, "bdt-transition"),
                            Ve(o, G({ transitionProperty: Object.keys(s).map(Ge).join(","), transitionDuration: a + "ms", transitionTimingFunction: h }, s));
                    });
                })
            )
        );
    ...
    var Ze = {
            ...
            inProgress: function (t) {
                return Oe(t, "bdt-transition");
            },
        },
        Qe = "bdt-animation-",
        ti = "bdt-cancel-animation";
                ...
                V(t).map(function (s) {
                    return new se(function (n, r) {
                        if (Oe(s, ti))
                            ...
                            w(e, Qe) && (a && (t += " bdt-transform-origin-" + a), h && (t += " " + Qe + "reverse")),
                                o(),
                                Gt(
                                    s,
    ...
    function ai(t) {
        ...
        Ft(t) || "none" !== Ve(t, "display") || ((e = ot(t, "style")), (i = ot(t, "hidden")), ot(t, { style: (e || "") + ";display:block !important;", hidden: null }));
    ...
    function hi(t, e) {
        ...
        var i = si(t),
            n = si(e);
        return { top: i.top - n.top - j(Ve(e, "borderTopWidth")), left: i.left - n.left - j(Ve(e, "borderLeftWidth")) };
    }
    function ui(t) {
        var e = [0, 0];
        t = W(t);
    ...
    function _i(e, i, n) {
        var r = {};
        if (($(i) && (i = i.options), i.extends && (e = _i(e, i.extends, n)), i.mixins)) for (var t = 0, o = i.mixins.length; t < o; t++) e = _i(e, i.mixins[t], n);
        for (var s in e) h(s);
                        ...
                        i = i.then(function () {
                            return new se(function (i) {
                                var t,
                                    ...
                                    h = function () {
                                        var t,
                                            e = ((t = tt((Date.now() - a) / s)), 0.5 * (1 - Math.cos(Math.PI * t)));
            ...
            : (function () {
                  function t(e, t) {
                      ...
                      (this.offsetTop = s),
                          ...
                          (this.off = Yt(window, "scroll resize load", this.apply, { passive: !0, capture: !0 }));
                  }
                  return (
    ...
    function Ri(t) {
        return !(!w(t, "bdt-") && !w(t, "data-bdt-")) && f(t.replace("data-bdt-", "").replace("bdt-", ""));
    }
    function qi(t) {
        this._init(t);
    }
    ...
    function on(e, i, n) {
        ...
        (r = $(r) ? r.call(e) : r || e.$el),
            k(r)
                ...
                : !r || (u && !u.call(e)) || e._events.push(Yt(r, t, h ? (D(h) ? h : h.call(e)) : null, D(o) ? e[o] : o.bind(e), { passive: a, capture: s, self: c }));
    }
    function sn(t, e) {
    ...
    (qi.util = Object.freeze({
        ...
        ((Ki = qi).prototype._init = function (t) {
            ((t = t || {}).data = (function (t, e) {
                ...
                (this.$options = _i(this.constructor.options, t, this)),
                (this.$el = null),
                (this.$props = {}),
                (this._uid = Ji++),
                this._initData(),
        ...
        (Zi.component = function (s, t) {
            ...
            Zi[s] = function (t, i) {
                ...
                return r.options.functional ? new r({ data: T(t) ? t : [].concat(n) }) : t ? Me(t).map(o)[0] : o(t);
                function o(t) {
        ...
        un = {
            ...
            methods: {
                    ...
                    return new se(function (t) {
                        ...
                        if (!d.queued || !H(c) || !d.hasAnimation || u.length < 2) i = e(u);
                            ...
                            var n = u.filter(function (t) {
                                ...
                                s = o.scrollTop,
                                a = n[0],
                                h = (ni.inProgress(a) && Oe(a, "bdt-animation-leave")) || (Ze.inProgress(a) && "0px" === a.style.height);
                            (i = e(n)),
                                h ||
                                    (i = i.then(function () {
                                        var t = e(r);
                ...
                _toggleElement: function (t, e, i) {
                    var n = this;
                    if (
                        ((e = z(e) ? e : ni.inProgress(t) ? Oe(t, "bdt-animation-leave") : Ze.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t)),
                ...
                _toggle: function (t, e) {
                    ...
                    t &&
                        ((e = Boolean(e)),
                        this.cls ? (i = b(this.cls, " ") || e !== Oe(t, this.cls)) && He(t, this.cls, b(this.cls, " ") ? void 0 : e) : (i = e === st(t, "hidden")) && ot(t, "hidden", e ? null : ""),
    ...
    function cn(t) {
        ...
        return function (t, e) {
            ...
            return (
                ci(t, r),
                (e
                    ? Ze.start(t, G({}, h, { overflow: "hidden", height: o }), Math.round(a * (1 - r / o)), c)
                    : Ze.start(t, u, Math.round(a * (r / o)), c).then(function () {
                          return l(t, !1);
                      })
                ).then(function () {
                    return Ve(t, h);
        ...
        methods: {
            toggle: function (t, r) {
                ...
                this.multiple || b(i, e[0]) || (e = e.concat(i)),
                    (this.collapsible || Vt(e, ":not(." + this.clsOpen + ")").length) &&
                        e.forEach(function (t) {
                            return o.toggleElement(t, !Oe(t, o.clsOpen), function (e, i) {
                                ...
                                if (!1 !== r && o.hasTransition)
                                    return (
                                        e._wrapper || (e._wrapper = $e(n, "<div" + (i ? " hidden" : "") + ">")),
                                        dn(n, !1),
                                        cn(o)(e._wrapper, i).then(function () {
    ...
    var fn = {
            ...
            args: "animation",
            props: { close: String },
            data: { animation: [!0], selClose: ".bdt-alert-close", duration: 150, hideProps: G({ opacity: 0 }, un.data.hideProps) },
            events: [
                {
                    name: "click",
                    delegate: function () {
        ...
        pn = {
            ...
            update: {
                read: function () {
                    return !!this.player && { visible: Ft(this.$el) && "hidden" !== Ve(this.$el, "visibility"), inView: this.inView && Bi(this.$el) };
                },
                write: function (t) {
                    var e = t.visible,
                        i = t.inView;
    ...
    var gn,
        vn = {
            ...
            methods: {
                positionAt: function (t, e, i) {
                    var n;
                    Be(t, this.clsPos + "-(top|bottom|left|right)(-[a-z]+)?"), Ve(t, { top: "", left: "" });
                    var r = this.offset,
                        o = this.getAxis();
                    ...
                    var s = oi(
                            t,
                            e,
                            "x" === o ? vi(this.dir) + " " + this.align : this.align + " " + vi(this.dir),
        ...
        wn = {
            ...
            data: { mode: ["click", "hover"], toggle: "- *", boundary: window, boundaryAlign: !1, delayShow: 0, delayHide: 800, clsDrop: !1, animation: ["bdt-animation-fade"], cls: "bdt-open" },
            computed: {
                boundary: function (t, e) {
                    return xt(t.boundary, e);
                },
                clsDrop: function (t) {
                    return t.clsDrop || "bdt-" + this.$options.name;
                },
                clsPos: function () {
                    return this.clsDrop;
                },
            ...
            connected: function () {
                ...
                (this.toggle = t && this.$create("toggle", xt(t, this.$el), { target: this.$el, mode: this.mode })), this.toggle || Kt(this.$el, "updatearia");
            },
            ...
            events: [
                ...
                },
                {
                    ...
                    handler: function (t) {
                        var e = t.target;
                        this.$el === e
                            ? ((gn = this.isActive() ? null : gn), Kt(this.$el, "updatearia"), this.tracker.cancel())
                            : (gn = null === gn && Rt(e, this.$el) && this.isToggled() ? this : gn);
                    },
                },
                {
                    name: "updatearia",
                    ...
                    handler: function (t, e) {
                        t.preventDefault(),
                            ...
                            (e || this.toggle) && (ot((e || this.toggle).$el, "aria-expanded", this.isToggled()), He(this.toggle.$el, this.cls, this.isToggled()));
                    },
                },
            ],
            update: {
    ...
    var bn = {
                    ...
                    var i,
                        ...
                        o =
                            e.files && e.files[0]
                                ? e.files[0].name
                                : Nt(e, "select") &&
                                  (i = Me("option", e).filter(function (t) {
                                      return t.selected;
                                  })[0])
                                ? i.textContent
                                : e.value;
        ...
        yn = {
            ...
            update: {
                read: function () {
                    return { rows: kn(this.$el.children) };
                },
                write: function (t) {
                    var n = this;
    ...
    var In = {
        ...
        connected: function () {
            this.masonry && ze(this.$el, "bdt-flex-top bdt-flex-wrap-top");
        },
        update: [
            {
                read: function (t) {
            ...
            },
            {
                read: function (t) {
                    var e = t.height;
                    return { scrolled: !!this.parallax && Hi(this.$el, e ? e - ci(this.$el) : 0) * this.parallax };
                },
                write: function (t) {
                    var e = t.rows,
                        n = t.scrolled,
    ...
    var Sn = ut
        ...
        Tn = {
            ...
            update: {
                read: function () {
                    return { rows: (this.row ? kn(this.elements) : [this.elements]).map(En) };
                },
                write: function (t) {
    ...
    function En(t) {
        ...
        return (
            o && s && (Ve(t, "minHeight", ""), (e = An(t)), (n = e.heights), (r = e.max)),
            {
        ...
        update: {
            read: function (t) {
                ...
                if (this.expand) {
                    ...
                    !0 === this.offsetBottom
                        ? (i += " - " + _n(this.$el.nextElementSibling) + "px")
                        : P(this.offsetBottom)
                        ? (i += " - " + this.offsetBottom + "vh")
                        : this.offsetBottom && u(this.offsetBottom, "px")
                        ? (i += " - " + j(this.offsetBottom) + "px")
                        : D(this.offsetBottom) && (i += " - " + _n(xt(this.offsetBottom, this.$el)) + "px"),
                        (i += (n ? " - " + n + "px" : "") + ")");
                }
            ...
            write: function (t) {
                ...
                Ve(this.$el, { minHeight: e }),
                    ...
                    this.minHeight && j(Ve(this.$el, "minHeight")) < this.minHeight && Ve(this.$el, "minHeight", this.minHeight);
            },
            events: ["resize"],
        },
    };
    ...
    var Mn = {
            ...
            beforeConnect: function () {
                var t,
                    e = this;
                if (((this.class += " bdt-svg"), !this.icon && b(this.src, "#"))) {
            ...
            disconnected: function () {
                var e = this;
                Lt(this.$el) && ot(this.$el, "hidden", null),
                    this.svg &&
            ...
            update: {
                ...
                write: function () {
                    var t, e;
                    (t = this.svgEl), (e = Bn(t)) && t.style.setProperty("--bdt-animation-stroke", e);
                },
                type: ["resize"],
            },
            methods: {
    ...
    var On = {
        ...
        Fn = {
            extends: Ln,
            beforeConnect: function () {
                ze(this.$el, "bdt-slidenav");
            },
            computed: {
                icon: function (t, e) {
                    var i = t.icon;
                    return Oe(e, "bdt-slidenav-large") ? i + "-large" : i;
                },
            },
        },
        jn = {
            ...
            computed: {
                icon: function (t, e) {
                    var i = t.icon;
                    return Oe(e, "bdt-search-icon") && qt(e, ".bdt-search-large").length ? "search-large" : qt(e, ".bdt-search-navbar").length ? "search-navbar" : i;
                },
            },
        },
        Wn = {
            ...
            computed: {
                icon: function () {
                    return "close-" + (Oe(this.$el, "bdt-close-large") ? "large" : "icon");
                },
            },
        },
        Vn = {
    ...
    var qn = {
        ...
        connected: function () {
            tr[this.cacheKey]
                ? Un(this.$el, tr[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes)
                : this.isImg &&
                  this.width &&
                  this.height &&
                  Un(
                      ...
                      (function (t, e, i) {
                          var n;
                          i && ((n = rt.ratio({ width: t, height: e }, "width", wi(Xn(i)))), (t = n.width), (e = n.height));
                          return 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="' + t + '" height="' + e + '"></svg>';
                      })(this.width, this.height, this.sizes)
                  ),
                (this.observer = new Vi(this.load, { rootMargin: this.offsetTop + "px " + this.offsetLeft + "px" })),
                ...
                if (this.dataSrcset && 1 !== window.devicePixelRatio) {
                    ...
                    (!e.match(/^(auto\s?)+$/) && j(e) !== t.bgSize) ||
                        ((t.bgSize =
                            ...
                            (n = this.sizes),
                            (r = wi(Xn(n))),
                            (o = (i.match(Jn) || []).map(j).sort(function (t, e) {
                                return t - e;
                            })).filter(function (t) {
                                return r <= t;
                            })[0] ||
        ...
        sr = {
            ...
            events: [
                ...
                },
                {
                    ...
                    handler: function () {
                        var o = this;
                        li(window) - li(document) && this.overlay && Ve(document.body, "overflowY", "scroll"),
                            this.stack && Ve(this.$el, "zIndex", Ve(this.$el, "zIndex") + or.length),
                ...
                },
                {
                    ...
                    handler: function () {
                        var e = this;
                        or.splice(or.indexOf(this), 1),
                            or.length || Ve(document.body, "overflowY", ""),
                            Ve(this.$el, "zIndex", ""),
                            or.some(function (t) {
            ...
            return new se(function (i, n) {
                return Gt(r, "show hide", function () {
                    ...
                    var t = Gt(
                            ...
                            "transitionstart",
                            function () {
                                Gt(s, "transitionend transitioncancel", i, { self: !0 }), clearTimeout(e);
                            },
                            { self: !0 }
                        ),
    ...
    var hr = {
        install: function (t) {
            ...
            (a.dialog = function (t, e) {
                var i = a('<div class="bdt-modal"> <div class="bdt-modal-dialog">' + t + "</div> </div>", e);
                return (
                    i.show(),
                    Yt(
                        i.$el,
        ...
        mixins: [sr],
        data: { clsPage: "bdt-modal-page", selPanel: ".bdt-modal-dialog", selClose: ".bdt-modal-close, .bdt-modal-close-default, .bdt-modal-close-outside, .bdt-modal-close-full" },
        events: [
            {
                name: "show",
                self: !0,
                handler: function () {
                    Oe(this.panel, "bdt-margin-auto-vertical") ? ze(this.$el, "bdt-flex") : Ve(this.$el, "display", "block"), ci(this.$el);
                },
            },
            {
                name: "hidden",
                self: !0,
                handler: function () {
                    Ve(this.$el, "display", ""), De(this.$el, "bdt-flex");
                },
            },
        ],
    };
    var ur = { extends: ln, data: { targets: "> .bdt-parent", toggle: "> a", content: "> ul" } },
        cr = {
            mixins: [hn, Sn],
            props: {
                dropdown: String,
            ...
            computed: {
                ...
                dropbar: {
                    get: function (t) {
                        var e = t.dropbar;
                        return e ? (e = this._dropbar || xt(e, this.$el) || _e("+ .bdt-navbar-dropbar", this.$el)) || (this._dropbar = _e("<div></div>")) : null;
                    },
                    watch: function (t) {
                        ze(t, "bdt-navbar-dropbar");
                    },
                    immediate: !0,
                },
                dropdowns: {
                ...
                },
                {
                    ...
                    handler: function (t, e) {
                        ...
                        He(
                            ...
                            "bottom" === n && this.transitionTo(i.offsetHeight + j(Ve(i, "marginTop")) + j(Ve(i, "marginBottom")), i);
                    },
                },
                {
                    name: "beforehide",
            ...
            methods: {
                ...
                transitionTo: function (t, e) {
                    var i = this,
                        ...
                        r = Ft(n) ? ci(n) : 0;
                    return (
                        Ve((e = r < t && e), "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"),
                        ci(n, r),
                        Ze.cancel([e, n]),
                        se
                            .all([Ze.start(n, { height: t }, this.duration), Ze.start(e, { clip: "rect(0," + e.offsetWidth + "px," + t + "px,0)" }, this.duration)])
                            .catch(et)
                            .then(function () {
        ...
        lr = {
            ...
            events: [
                ...
                },
                {
                    ...
                    self: !0,
                    handler: function () {
                        "reveal" !== this.mode || Oe(this.panel.parentNode, this.clsMode) || ($e(this.panel, "<div>"), ze(this.panel.parentNode, this.clsMode)),
                            ...
                            this.clsContainerAnimation && (dr().content += ",user-scalable=0");
                    },
                },
                {
                    name: "hide",
                ...
                },
                {
                    ...
                    handler: function () {
                        var t;
                        this.clsContainerAnimation && ((t = dr()).content = t.content.replace(/,user-scalable=0$/, "")),
    ...
    var fr = {
            ...
            data: { selContainer: ".bdt-modal", selContent: ".bdt-modal-dialog" },
            computed: {
            ...
            update: {
                read: function () {
                    return !(!this.content || !this.container) && { current: j(Ve(this.$el, "maxHeight")), max: Math.max(150, ci(this.container) - (si(this.content).height - ci(this.$el))) };
                },
                write: function (t) {
                    var e = t.current,
                        i = t.max;
        ...
        pr = {
            props: ["width", "height"],
            connected: function () {
                ze(this.$el, "bdt-responsive-width");
            },
            update: {
                read: function () {
                    return !!(Ft(this.$el) && this.width && this.height) && { width: li(this.$el.parentNode), height: this.height };
                },
                write: function (t) {
                    ci(this.$el, rt.contain({ height: this.height, width: this.width }, t).height);
                },
                events: ["resize"],
            },
        },
        ...
        gr = {
            ...
            data: function () {
                return { cls: !1, target: !1, hidden: !0, offsetTop: 0, offsetLeft: 0, repeat: !1, delay: 0, inViewClass: "bdt-scrollspy-inview" };
            },
            computed: {
                elements: {
                    get: function (t, e) {
                    ...
                    read: function (t) {
                        ...
                        t.update &&
                            this.elements.forEach(function (t) {
                                ...
                                ((e = e || { cls: ht(t, "bdt-scrollspy-class") || i.cls }).show = Bi(t, i.offsetTop, i.offsetLeft)), (t._ukScrollspyState = e);
                            });
                    },
                    write: function (n) {
                        var r = this;
        ...
        wr = {
            ...
            computed: {
                ...
                isActive: {
                    ...
                    set: function (t) {
                        t && !this.isActive
                            ? (Pe(this.selTarget, this.clsInactive, this.clsActive), Kt(this.$el, "active"))
                            : t || Oe(this.selTarget, this.clsInactive) || (Pe(this.selTarget, this.clsActive, this.clsInactive), Kt(this.$el, "inactive"));
                    },
                },
            },
            connected: function () {
                (this.placeholder = _e("+ .bdt-sticky-placeholder", this.$el) || _e('<div class="bdt-sticky-placeholder"></div>')), (this.isFixed = !1), (this.isActive = !1);
            },
            disconnected: function () {
            ...
            update: [
                {
                    read: function (t, e) {
                        ...
                        return (
                            (this.top = Math.max(j(br("top", this)), this.topOffset) - this.offset),
                            (this.bottom = n && n - this.$el.offsetHeight),
                            (this.inactive = !this.matchMedia),
                            { lastScroll: !1, height: i, margins: Ve(this.$el, ["marginTop", "marginBottom", "marginLeft", "marginRight"]) }
                        );
                    },
                    write: function (t) {
                        var e = t.height,
                            i = t.margins,
                            n = this.placeholder;
                        Ve(n, G({ height: e }, i)), Rt(n, document) || (xe(this.$el, n), ot(n, "hidden", "")), (this.isActive = this.isActive);
                    },
                    events: ["resize"],
                },
                {
                    read: function (t) {
                        ...
                        return (
                            void 0 === e && (e = 0),
                            (this.width = si(Ft(this.widthElement) ? this.widthElement : this.$el).width),
                            (this.scroll = window.pageYOffset),
                            { dir: e <= this.scroll ? "down" : "up", scroll: this.scroll, visible: Ft(this.$el), top: ui(this.placeholder)[0] }
                        );
                    },
                    write: function (t, e) {
                        var i = this,
                        ...
                        if (
                            !(
                                ...
                                ((300 < c - n || r !== o) && ((t.initScroll = a), (t.initTimestamp = c)),
                                (t.lastDir = r),
            ...
            methods: {
                ...
                hide: function () {
                    (this.isActive = !1), De(this.$el, this.clsFixed, this.clsBelow), Ve(this.$el, { position: "", top: "", width: "" }), ot(this.placeholder, "hidden", "");
                },
                update: function () {
                    var t = 0 !== this.top || this.scroll > this.top,
                        e = Math.max(0, this.offset);
                    P(this.bottom) && this.scroll > this.bottom - this.offset && (e = this.bottom - this.scroll),
                        Ve(this.$el, { position: "fixed", top: e + "px", width: this.width }),
                        (this.isActive = t),
    ...
    var xr = {
            ...
            data: { connect: "~.bdt-switcher", toggle: "> * > :first-child", active: 0, swiping: !0, cls: "bdt-active", clsContainer: "bdt-switcher", attrItem: "bdt-switcher-item", queued: !0 },
            computed: {
                connects: {
                    get: function (t, e) {
                ...
                toggles: {
                    get: function (t, e) {
                        return Me(t.toggle, e).filter(function (t) {
                            return !Nt(t, ".bdt-disabled *, .bdt-disabled, [disabled]");
                        });
                    },
                    watch: function (t) {
                        var e = this.index();
        ...
        yr = {
            ...
            connected: function () {
                var t = Oe(this.$el, "bdt-tab-left") ? "bdt-tab-left" : !!Oe(this.$el, "bdt-tab-right") && "bdt-tab-right";
                ...
                },
                {
                    ...
                    handler: function (t) {
                        ...
                        (Dt(t.target, 'a[href="#"], a[href=""]') ||
                            ((e = Dt(t.target, "a[href]")) && ((this.cls && !Oe(this.target, this.cls.split(" ")[0])) || !Ft(this.target) || (e.hash && Nt(this.target, e.hash))))) &&
                            t.preventDefault(),
                            this.toggle();
                    },
                },
            ...
            methods: {
                animate: function (t) {
                    ...
                    var s = ci(this.target),
                        a = (r = r.concat(
                            Ut(this.target).filter(function (t) {
                                return !b(r, t);
                            })
                        )).map(function (t, e) {
                            return !!(t.parentNode && e in o) && (o[e] ? (Ft(t) ? _r(t) : { opacity: 0 }) : { opacity: Ft(t) ? 1 : 0 });
                        });
                    return (
                        ...
                        Ve(this.target, { height: e, display: "block" }),
                        Pi(window, i),
                        se
                            .all(
                                r
                                    ...
                                    .concat(e !== s && Ze.start(this.target, { height: s }, this.animation, "ease"))
                            )
                            .then(function () {
                                r.forEach(function (t, e) {
    ...
    function Ar(t, e) {
        var i = Ve(t, "zIndex");
        return !!Ft(t) && G({ display: "", opacity: e ? Ve(t, "opacity") : "0", pointerEvents: "none", position: "absolute", zIndex: "auto" === i ? pe(t) : i }, _r(t));
    }
    function Cr(t) {
        Ve(t.children, { height: "", left: "", opacity: "", pointerEvents: "", position: "", top: "", width: "" }), De(t, Tr), Ve(t, { height: "", display: "" });
    }
    function _r(t) {
        var e = si(t),
            i = e.height,
    ...
    var Mr = {
        ...
        data: { target: null, selActive: !1, attrItem: "bdt-filter-control", cls: "bdt-active", animation: 250 },
        computed: {
            toggles: {
                get: function (t, e) {
                    t.attrItem;
        ...
        methods: {
            ...
            setState: function (u, t) {
                var c = this;
                void 0 === t && (t = !0), (u = G({ filter: { "": "" }, sort: [] }, u)), Kt(this.$el, "beforeFilter", [this, u]);
                var l = this.children;
                this.toggles.forEach(function (t) {
                    return He(
                        t,
                ...
                function e() {
                    ...
                    if (s) {
                        var h =
                            ((n = s),
                            (r = a),
                            G([], l).sort(function (t, e) {
                                return ht(t, n).localeCompare(ht(e, n), void 0, { numeric: !0 }) * ("asc" === r || -1);
                            }));
                        Y(h, l) ||
    ...
    function zr(t, e, i) {
        ...
        return (
            void 0 === a && (a = "asc"),
            (r || H(s)) && (o ? (r ? (delete i.filter[""], (i.filter[o] = r)) : (delete i.filter[o], (O(i.filter) || "" in i.filter) && (i.filter = { "": r || "" }))) : (i.filter = { "": r || "" })),
            H(s) || (i.sort = [s, a]),
            i
        );
    }
    var Dr = {
        slide: {
            ...
            translate: function (t, e) {
                return [{ transform: Pr(-100 * e * t) }, { transform: Pr(100 * e * (1 - t)) }];
            },
        },
    };
    function Br(t) {
    ...
    var Hr = G({}, Dr, {
        ...
        scale: {
            show: function () {
                return [
                    { opacity: 0, transform: Or(0.8) },
                    { opacity: 1, transform: Or(1) },
                ];
            },
            percent: function (t) {
                return 1 - Ve(t, "opacity");
            ...
            translate: function (t) {
                return [
                    { opacity: 1 - t, transform: Or(1 - 0.2 * t) },
                    { opacity: t, transform: Or(0.8 + 0.2 * t) },
                ];
            },
        },
    });
    ...
    var Fr = {
                ...
                methods: {
                    start: function () {
                        ...
                        (this.unbindMove = function () {
                            ...
                            Yt(window, "scroll", this.unbindMove),
                            Yt(window.visualViewport, "resize", this.unbindMove),
                            Yt(document, gt + " " + bt, this.end, !0),
                    ...
                    move: function (t) {
                        ...
                        if (this.unbindMove) {
                            ...
                            if (!(0 == i || this.prevPos === this.pos || (!this.dragging && Math.abs(i) < this.threshold))) {
                                ...
                                [this.index, this.prevIndex]
                                    ...
                                    ((this.index === r && this.prevIndex !== r) || h) && Kt(n[this.index], "itemshown", [this]),
                                    l && ((this.prevIndex = r), (this.index = s), d || Kt(u, "beforeitemhide", [this]), Kt(c, "beforeitemshow", [this])),
                                    (this._transitioner = this._translate(Math.abs(this.percent), u, !d && c)),
                                    l && (d || Kt(u, "itemhide", [this]), Kt(c, "itemshow", [this]));
                            }
                        }
                    },
                    end: function () {
                        ...
                        Ve(this.list, { userSelect: "", pointerEvents: "" }), (this.drag = this.percent = null);
                    },
                },
            },
            {
                ...
                update: {
                    write: function () {
                        ...
                        this.nav &&
                            ...
                            He(Me(this.selNavItem, this.$el).concat(this.nav), "bdt-hidden", !this.maxIndex),
                            this.updateNav();
                    },
                    events: ["resize"],
                },
                ...
                methods: {
                    updateNav: function () {
                        ...
                        this.navItems.forEach(function (t) {
                            ...
                            He(t, i.clsActive, F(e) === n), He(t, "bdt-invisible", i.finite && (("previous" === e && 0 === n) || ("next" === e && n >= i.maxIndex)));
                        });
                    },
                },
            },
        ...
        data: function () {
            return { easing: "ease", finite: !1, velocity: 1, index: 0, prevIndex: -1, stack: [], percent: 0, clsActive: "bdt-active", clsActivated: !1, Transitioner: !1, transitionOptions: {} };
        },
        connected: function () {
        ...
        methods: {
                ...
                if ((void 0 === e && (e = !1), !this.dragging && this.length)) {
                    ...
                    if ((n[e ? "unshift" : "push"](t), !e && 1 < n.length)) 2 === n.length && this._transitioner.forward(Math.min(this.duration, 200));
                        ...
                        if (a !== u) {
                            var c, l;
                            if (
                                ((this.dir = ((l = s), "next" !== (c = t) && ("previous" === c || c < l) ? -1 : 1)),
                                (this.prevIndex = s),
                                (this.index = h),
                                (a && !Kt(a, "beforeitemhide", [this])) || !Kt(u, "beforeitemshow", [this, a]))
                            )
            ...
            _show: function (t, e, i) {
                if (
                    ((this._transitioner = this._getTransitioner(
                        ...
                        e,
                        this.dir,
                        G({ easing: i ? (e.offsetWidth < 600 ? "cubic-bezier(0.25, 0.46, 0.45, 0.94)" : "cubic-bezier(0.165, 0.84, 0.44, 1)") : this.easing }, this.transitionOptions)
                    )),
                    !i && !t)
                )
            ...
            _getTransitioner: function (t, e, i, n) {
                return (
                    ...
                    new this.Transitioner(B(t) ? this.slides[t] : t, B(e) ? this.slides[e] : e, i * (ct ? -1 : 1), n)
                );
            },
        },
    };
                    ...
                    return {
                        ...
                        show: function (t, e, i) {
                            ...
                            return (
                                ...
                                this.translate(e),
                                Lr(s, "itemin", { percent: e, duration: t, timing: r, dir: a }),
                                Lr(o, "itemout", { percent: 1 - e, duration: t, timing: r, dir: a }),
                        ...
                        translate: function (t) {
                            this.reset();
                            var e = n(t, a);
                            Ve(s, e[1]), Ve(o, e[0]), Lr(s, "itemtranslatein", { percent: t, dir: a }), Lr(o, "itemtranslateout", { percent: 1 - t, dir: a });
                        },
                        percent: function () {
                            return i(o || s, s, a);
                        },
        ...
        Vr = {
            ...
            computed: {
                caption: function (t, e) {
                    t.selCaption;
                    return _e(".bdt-lightbox-caption", e);
                },
            },
            events: [
                ...
                },
                {
                    ...
                    handler: function (t, r) {
                        ...
                        var i = r.poster,
                            a = r.attrs;
                        if ((void 0 === a && (a = {}), this.setItem(r, "<span bdt-spinner></span>"), n)) {
                            var h,
                                u = {
                                    frameborder: "0",
                                    allow: "autoplay",
                            ...
                            if ("image" === e || n.match(/\.(jpe?g|png|gif|svg|webp)($|\?)/i))
                                de(n, a.srcset, a.size).then(
                                    function (t) {
                                        var e = t.width,
                                            i = t.height;
                                        return o.setItem(r, Rr("img", G({ src: n, width: e, height: i, alt: s }, a)));
                                    },
                                    function () {
                                        return o.setError(r);
                                    }
                                ...
                                var c = Rr("video", G({ src: n, poster: i, controls: "", playsinline: "", "bdt-video": "" + this.videoAutoplay }, a));
                                Yt(c, "loadedmetadata", function () {
                                    ot(c, { width: c.videoWidth, height: c.videoHeight }), o.setItem(r, c);
                                }),
                                    Yt(c, "error", function () {
                                        return o.setError(r);
                                    });
                                ...
                                "iframe" === e || n.match(/\.(html|php)($|\?)/i)
                                    ? this.setItem(r, Rr("iframe", G({ src: n, frameborder: "0", allowfullscreen: "", class: "bdt-lightbox-iframe" }, a)))
                                    : (h = n.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/))
                                    ? this.setItem(r, Rr("iframe", G({ src: "https://www.youtube" + (h[1] || "") + ".com/embed/" + h[2] + (h[3] ? "?" + h[3] : ""), width: 1920, height: 1080 }, u, a)))
                                    : (h = n.match(/\/\/.*?vimeo\.[a-z]+\/(\d+)[&?]?(.*)?/)) &&
                                      le("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(n), { responseType: "json", withCredentials: !1 }).then(
                                          function (t) {
                                              var e = t.response,
                                                  i = e.height,
                                                  n = e.width;
                                              return o.setItem(r, Rr("iframe", G({ src: "https://player.vimeo.com/video/" + h[1] + (h[2] ? "?" + h[2] : ""), width: n, height: i }, u, a)));
                                          },
                                          function () {
                                              return o.setError(r);
                                          }
            ...
            methods: {
                ...
                showControls: function () {
                    clearTimeout(this.controlsTimer), (this.controlsTimer = setTimeout(this.hideControls, this.delayControls)), ze(this.$el, "bdt-active", "bdt-transition-active");
                },
                hideControls: function () {
                    De(this.$el, "bdt-active", "bdt-transition-active");
                },
            },
        };
    function Rr(t, e) {
    ...
    var Xr = {
        functional: !0,
        args: ["message", "status"],
        data: { message: "", status: "", timeout: 5e3, group: null, pos: "top-center", clsContainer: "bdt-notification", clsClose: "bdt-notification-close", clsMsg: "bdt-notification-message" },
        install: function (r) {
        ...
        created: function () {
            var t =
                _e("." + this.clsContainer + "-" + this.pos, this.$container) ||
                we(this.$container, '<div class="' + this.clsContainer + " " + this.clsContainer + "-" + this.pos + '" style="display: block"></div>');
            this.$mount(
                we(
                    t,
                    '<div class="' +
        ...
        connected: function () {
            ...
            Ze.start(Ve(this.$el, this.startProps), (((t = { opacity: 1 })[this.marginProp] = i), t)).then(function () {
    ...
    var Gr = ["x", "y", "bgx", "bgy", "rotate", "scale", "color", "backgroundColor", "borderColor", "opacity", "blur", "hue", "grayscale", "invert", "saturate", "sepia", "fopacity", "stroke"],
        Kr = {
                    ...
                    return Gr.reduce(function (t, e) {
                        ...
                        if (o) {
                            ...
                            if (
                                ...
                                (n = Ve(g, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1]),
                                v.covers)
                            ) {
            ...
            update: {
                ...
                write: function (t) {
                    var e = t.dim;
                    t.active ? e && Ve(this.$el, { backgroundSize: e.width + "px " + e.height + "px", backgroundRepeat: "no-repeat" }) : Ve(this.$el, { backgroundSize: "", backgroundRepeat: "" });
                },
                events: ["resize"],
            },
            methods: {
            ...
            read: function (t, e) {
                ...
                if (("scroll" !== e && (i = !1), t.active)) {
                    var n,
                        r,
                        o = i;
                    return (n = Hi(this.target) / (this.viewport || 1)), (r = this.easing), { percent: (i = tt(n * (1 - (r - r * n)))), style: o !== i && this.getCss(i) };
                }
            },
            write: function (t) {
                var e = t.style;
    ...
    var so = {
                    ...
                    return {
                        ...
                        show: function (t, e, i) {
                            ...
                            return (
                                ...
                                (e = r ? e : tt(e, 0, 1)),
                                ro(this.getItemIn(), "itemin", { percent: e, duration: t, timing: n, dir: o }),
                                r && ro(this.getItemIn(!0), "itemout", { percent: 1 - e, duration: t, timing: n, dir: o }),
                                Ze.start(a, { transform: Pr(-u * (ct ? -1 : 1), "px") }, t, n).then(h.resolve, et),
                                h.promise
                            );
                        },
                        stop: function () {
                        ...
                        translate: function (t) {
                            ...
                            Ve(a, "transform", Pr(tt(e - e * t - u, -io(a), si(a).width) * (ct ? -1 : 1), "px")),
                                this.updateTranslates(),
                                r && ((t = tt(t, -1, 1)), ro(this.getItemIn(), "itemtranslatein", { percent: t, dir: o }), ro(this.getItemIn(!0), "itemtranslateout", { percent: 1 - t, dir: o }));
                        },
                        percent: function () {
                        ...
                        updateTranslates: function () {
                            ...
                            oo(a).forEach(function (t) {
                                var e = b(i, t);
                                ro(t, "itemtranslate" + (e ? "in" : "out"), { percent: e ? 1 : 0, dir: t.offsetLeft <= n.offsetLeft ? 1 : -1 });
                            });
                        },
                    };
                },
            ...
            computed: {
                ...
                finite: function (t) {
                    return (
                        ...
                        Math.ceil(io(this.list)) <
                            si(this.list).width +
                                oo(this.list).reduce(function (t, e) {
                ...
                maxIndex: function () {
                    ...
                    for (var t = eo(this.list), e = this.length; e--; ) if (no(this.list.children[e], this.list) < t) return Math.min(e + 1, this.length - 1);
                    return 0;
                },
                sets: function (t) {
                    var o = this,
            ...
            update: {
                write: function () {
                    ...
                    Me("[" + this.attrItem + "],[data-" + this.attrItem + "]", this.$el).forEach(function (t) {
                        var e = ht(t, i.attrItem);
                        i.maxIndex && He(t, "bdt-hidden", P(e) && ((i.sets && !b(i.sets, j(e))) || e > i.maxIndex));
                    }),
            ...
            events: {
                beforeitemshow: function (t) {
                    ...
                    var e = Math.abs(
                        this.index - this.prevIndex + ((0 < this.dir && this.index < this.prevIndex) || (this.dir < 0 && this.index > this.prevIndex) ? (this.maxIndex + 1) * this.dir : 0)
                    );
                    if (!this.dragging && 1 < e) {
                        ...
                        (this.duration =
                            jr(this.avgWidth / this.velocity) * (si(this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex]).width / this.avgWidth)),
                            this.reorder();
                },
                itemshow: function () {
                ...
                },
                {
                    ...
                    handler: function (t) {
                        var e = t.type,
                            ...
                            o = i.timing,
                            s = i.dir;
                        Ze.cancel(this.$el), Ve(this.$el, this.getCss(uo(e, s, n))), Ze.start(this.$el, this.getCss(ho(e) ? 0.5 : 0 < s ? 1 : 0), r, o).catch(et);
                    },
                },
                {
    ...
    var co,
        ...
        fo = G({}, Dr, {
            ...
            scale: {
                show: function () {
                    return [{ opacity: 0, transform: Or(1.5), zIndex: 0 }, { zIndex: -1 }];
                },
                percent: function (t) {
                    return 1 - Ve(t, "opacity");
                },
                translate: function (t) {
                    return [{ opacity: 1 - t, transform: Or(1 + 0.5 * t), zIndex: 0 }, { zIndex: -1 }];
                },
            },
            pull: {
                show: function (t) {
        ...
        po = {
            ...
            data: { ratio: "16:9", minHeight: !1, maxHeight: !1, selList: ".bdt-slideshow-items", attrItem: "bdt-slideshow-item", selNav: ".bdt-slideshow-nav", Animations: fo },
            update: {
                read: function () {
        ...
        mo = {
            ...
            computed: {
                ...
                handles: {
                    ...
                    watch: function (t, e) {
                        Ve(e, { touchAction: "", userSelect: "" }), Ve(t, { touchAction: ft ? "none" : "", userSelect: "none" });
                    },
                    immediate: !0,
                },
            },
            update: {
                write: function () {
                    if (this.drag && Bt(this.placeholder)) {
                        ...
                        Ve(this.drag, { top: tt(i - r, 0, l - a), left: tt(e - o, 0, c - h) });
            ...
            methods: {
                init: function (t) {
                    ...
                    !r ||
                        ...
                        Wt(e) ||
                        Rt(e, "." + this.clsNoDrag) ||
                        (this.handle && !Rt(e, this.handle)) ||
                        (t.preventDefault(),
                        (this.touched = [this]),
                        (this.placeholder = r),
                        (this.origin = G({ target: e, index: pe(r) }, this.pos)),
                        Yt(document, mt, this.move),
                        Yt(document, gt, this.end),
                ...
                start: function (t) {
                    ...
                    this.drag =
                        ((e = this.$container),
                        (i = this.placeholder),
                        ot((n = we(e, i.outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g, "$1div$2"))), "style", ot(n, "style") + ";margin:0!important"),
                        Ve(n, G({ boxSizing: "border-box", width: i.offsetWidth, height: i.offsetHeight, overflow: "hidden" }, Ve(i, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))),
                    ...
                    var r,
                        ...
                        a = s.left,
                        h = s.top;
                    G(this.origin, { offsetLeft: this.pos.x - a, offsetTop: this.pos.y - h }),
                ...
                move: function (t) {
                    ...
                    if ((Xt(document, mt, this.move), Xt(document, gt, this.end), Xt(window, "scroll", this.scroll), this.drag)) {
                        ...
                        this === e
                            ? this.origin.index !== pe(this.placeholder) && Kt(this.$el, "moved", [this, this.placeholder])
                            : (Kt(e.$el, "added", [e, this.placeholder]), Kt(this.$el, "removed", [this, this.placeholder])),
    ...
    var go = [],
        vo = {
            ...
            data: { pos: "top", title: "", delay: 0, animation: ["bdt-animation-scale-up"], duration: 100, cls: "bdt-active", clsPos: "bdt-tooltip" },
            beforeConnect: function () {
            ...
            methods: {
                show: function () {
                    ...
                    !this.isActive() &&
                        ...
                        go.push(this),
                        (this._unbind = Yt(document, gt, function (t) {
            ...
            events:
                (((lo = { focus: "show", blur: "hide" })[vt + " " + wt] = function (t) {
        ...
        qi.use(function (r) {
            fe(function () {
                ...
                Yt(
                    ...
                    function (t) {
                        var e = t.target;
                        (Ve(e, "animationName") || "").match(/^bdt-.*(left|right)/) &&
                            (n++,
                                    ...
                                    ((a && r && 100 < Math.abs(s.x - r)) || (o && 100 < Math.abs(s.y - o))) &&
                                        setTimeout(function () {
                                            ...
                                            Kt(a, "swipe"),
                                                Kt(
                                                    a,
                                                    "swipe" + ((t = s.x), (e = s.y), (i = r), (n = o), Math.abs(t - i) >= Math.abs(e - n) ? (0 < t - i ? "Left" : "Right") : 0 < e - n ? "Up" : "Down")
                                                );
                                        });
                                });
                            }
