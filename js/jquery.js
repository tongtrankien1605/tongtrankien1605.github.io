...
!(function (a, b) {
                    ...
                    preFilter: {
                        ...
                        CHILD: function (a) {
                            return (
                                (a[1] = a[1].toLowerCase()),
                                "nth" === a[1].slice(0, 3)
                                    ? (a[3] || ea.error(a[0]), (a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * ("even" === a[3] || "odd" === a[3]))), (a[5] = +(a[7] + a[8] || "odd" === a[3])))
                                    : a[3] && ea.error(a[0]),
                                a
                            );
                        },
                                ...
                                : function (b, c, i) {
                                      ...
                                      if (q) {
                                          ...
                                          if (((o = [g ? q.firstChild : q.lastChild]), g && s)) {
                                              ...
                                              (s && ((m = b), (l = m[u] || (m[u] = {})), (k = l[m.uniqueID] || (l[m.uniqueID] = {})), (j = k[a] || []), (n = j[0] === w && j[1]), (t = n)), !1 === t)
                                          )
                                              while ((m = (++n && m && m[p]) || (t = n = 0) || o.pop()))
                                                  if (
        ...
        n.extend({
            ...
            ready: function (a) {
                (!0 === a ? --n.readyWait : n.isReady) ||
                    ((n.isReady = !0), (!0 !== a && --n.readyWait > 0) || (H.resolveWith(d, [n]), n.fn.triggerHandler && (n(d).triggerHandler("ready"), n(d).off("ready"))));
            },
        });
    function I() {
    ...
    (n.event = {
                ...
                while ((f = h[b++]) && !a.isPropagationStopped()) {
                    ...
                    while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped())
                        (a.rnamespace && !a.rnamespace.test(g.namespace)) ||
                            ((a.handleObj = g),
                            (a.data = g.data),
                            void 0 !== (d = ((n.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, i)) && !1 === (a.result = d) && (a.preventDefault(), a.stopPropagation()));
                }
        ...
        (n.Event = function (a, b) {
            ...
            a && a.type
                ? ((this.originalEvent = a), (this.type = a.type), (this.isDefaultPrevented = a.defaultPrevented || (void 0 === a.defaultPrevented && !1 === a.returnValue) ? oa : pa))
                : (this.type = a),
                b && n.extend(this, b),
                ...
                for (j = i[i.length - 1].ownerDocument, n.map(i, Da), m = 0; m < h; m++)
                    (g = i[m]),
                        $.test(g.type || "") &&
                            ...
                            n.contains(j, g) &&
                            (g.src ? n._evalUrl && n._evalUrl(g.src) : n.globalEval((g.text || g.textContent || g.innerHTML || "").replace(ya, "")));
            k = e = null;
        }
        return a;
    }
        ...
        l.opacity ||
            (n.cssHooks.opacity = {
                ...
                set: function (a, b) {
                    ...
                    (c.zoom = 1),
                        ((b >= 1 || "" === b) && "" === n.trim(f.replace(Ua, "")) && c.removeAttribute && (c.removeAttribute("filter"), "" === b || (d && !d.filter))) ||
    ...
    (n.Animation = n.extend(pb, {
        ...
        n.each(
            { slideDown: lb("show"), slideUp: lb("hide"), slideToggle: lb("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } },
            function (a, b) {
    ...
    n.fn.extend({
        val: function (a) {
                ...
                e = this[0];
            {
                ...
                if (e)
                    return (b = n.valHooks[e.type] || n.valHooks[e.nodeName.toLowerCase()]) && "get" in b && void 0 !== (c = b.get(e, "value"))
                        ? c
