    ...
    var i = {
        ...
        widgetCountdown: function (t) {
            ...
            (i.widgetCountdown.initClock = function () {
                ...
                (i.widgetCountdown.getTimeRemaining = function (e) {
                    ...
                    return (
                        (r < 0 || o < 0 || n < 0) && (a = n = o = r = 0),
                        {
                            total: t,
                            parts: { days: i.widgetCountdown.splitNum(r), hours: i.widgetCountdown.splitNum(o), minutes: i.widgetCountdown.splitNum(n), seconds: i.widgetCountdown.splitNum(a) },
                        }
                    );
                }),
        ...
        widgetMap: function (t) {
            ...
            window.google &&
                ...
                ((a = o.data("init")),
                (n = o.data("pins")),
                (i = new google.maps.Map(o[0], a)),
                n &&
                    e.each(n, function (e, t) {
                        var a,
                            n,
                            o = { position: t.position, map: i };
                        "" !== t.image && (o.icon = t.image),
                            (a = new google.maps.Marker(o)),
                            "" !== t.desc && (n = new google.maps.InfoWindow({ content: t.desc, disableAutoPan: !0 })),
                            a.addListener("click", function () {
                                n.setOptions({ disableAutoPan: !1 }), n.open(i, a);
                            }),
        ...
        widgetProgress: function (t) {
            ...
            if (i.length) {
                var a = i.find(".circle-progress__value"),
                    ...
                    m = u,
                    f = !1;
                "tablet" === u && p(d.size, d.viewBox, d.center, d.radius, d.valStroke, d.bgStroke, d.circumference),
                    "mobile" === u && p(c.size, c.viewBox, c.center, c.radius, c.valStroke, c.bgStroke, c.circumference),
                    elementorFrontend.waypoint(
                        ...
                        function () {
                            ...
                            a.css({ transitionDuration: r + "ms", strokeDashoffset: l }), (f = !0);
                        },
                        { offset: "bottom-in-view" }
                    ),
                    e(window).on("resize.jetCircleProgress orientationchange.jetCircleProgress", function (e) {
                        "desktop" === (u = elementorFrontend.getCurrentDeviceMode()) &&
                            "desktop" !== m &&
                            (p(l.size, l.viewBox, l.center, l.radius, l.valStroke, l.bgStroke, l.circumference), (m = "desktop"));
            ...
            function p(e, t, r, s, l, d, c) {
                var u = c * (1 - o);
                i.attr({ width: e, height: e, "data-radius": s, "data-circumference": c }),
                    i[0].setAttribute("viewBox", t),
                    n.attr({ cx: r, cy: r, r: s, "stroke-width": d }),
                    f && a.css({ transitionDuration: "" }),
                    a.attr({ cx: r, cy: r, r: s, "stroke-width": l }),
                    a.css({ strokeDasharray: c, strokeDashoffset: f ? u : c });
            }
        },
                ...
                switch (s.switchEventType) {
                    ...
                    case "scratch":
                        !(function () {
                            ...
                            e("html, body").scrollTop(0),
                                html2canvas(document.querySelector("#jet-animated-box__front-" + s.widgetId), {
                                    allowTaint: !0,
                    ...
                    case "peel":
                        !(function () {
                            ...
                            var i = new Peel("#jet-animated-box-" + s.widgetId, { corner: Peel.Corners.TOP_RIGHT }),
                                a = r.width();
                            r.height();
                            i.setPeelPosition(a - 30, 40),
                                i.setFadeThreshold(0.8),
                                i.handleDrag(function (t, a, n) {
                                    var o = r.offset(),
                                        s = o.left,
                                        l = o.top,
                                        d = a - s,
                                    ...
                                    (d = d < 0 ? (d *= 3) : d),
                                        (c = c < 0 ? (c *= 3) : c),
                                        0.98 < this.getAmountClipped() && (this.removeEvents(), e(".peel-top, .peel-back, .peel-bottom-shadow", r).remove()),
                                        i.setPeelPosition(Math.round(d), Math.round(c));
                                });
                        })();
                        break;
                    case "slide-out":
                        (n = e(".jet-animated-box__front", r)),
                            e(".jet-animated-box__back", r),
                            r.width(),
                            r.height(),
                            (o = "left" === s.slideOutDirection || "right" === s.slideOutDirection ? "x" : "y"),
                            n.draggable({
                                axis: o,
                                drag: function (e, t) {
                                    var i = t.position;
        ...
        onAnimatedBoxSectionActivated: function (e) {
            if (window.elementor && window.JetElementsEditor && window.JetElementsEditor.activeSection) {
                ...
                -1 !== ["section_back_content", "section_action_button_style"].indexOf(t)
                    ? (e.find(".jet-animated-box").addClass("flipped"), e.find(".jet-animated-box").addClass("flipped-stop"))
                    : (e.find(".jet-animated-box").removeClass("flipped"), e.find(".jet-animated-box").removeClass("flipped-stop"));
            }
        },
        ...
        widgetInstagramGallery: function (t) {
            var i,
                a,
                n = t.find(".jet-instagram-gallery__instance");
            n.length && ((a = n.data("settings")), (i = { layoutType: "masonry", columns: 3, columnsTablet: 2, columnsMobile: 1 }), e.extend(i, a), "masonry" === a.layoutType && salvattore.init());
        },
            ...
            function g() {
                ...
                a.validateEmail(t)
                      ...
                      (r = e.ajax({
                          ...
                          success: function (t) {
                              ...
                              m.removeClass("loading"),
                                  ...
                                  o.redirect && (window.location.href = o.redirect_url),
                                  e(window).trigger({ type: "jet-elements/subscribe", elementId: n, successType: a, inputData: u });
                          },
                      })))
                    : (c.addClass("mail-invalid"),
                      ...
                      f.css({ visibility: "visible" }),
                      setTimeout(function () {
                          i.removeClass("jet-subscribe-form--response-error"), f.css({ visibility: "hidden" }), c.removeClass("mail-invalid");
                      }, 2e4));
            }
            c.on("focus", function () {
        ...
        widgetProgressBar: function (t) {
            ...
            elementorFrontend.waypoint(i, function (t) {
                ...
                "type-7" == n ? r.css({ height: a + "%" }) : r.css({ width: a + "%" }),
                    anime({
                        targets: o,
                        charged: a,
                        round: 1,
        ...
        widgetSlider: function (i) {
            ...
            if (a.length) {
                var r = "" !== o.sliderHeightTablet.size ? o.sliderHeightTablet.size + o.sliderHeightTablet.unit : o.sliderHeight.size + o.sliderHeight.unit,
                    ...
                    p = {};
                t.isEditMode() && (f -= 17),
                    (p[m] = { height: r, thumbnailWidth: l, thumbnailHeight: c }),
                    (p[f] = { height: s, thumbnailWidth: d, thumbnailHeight: u }),
        ...
        initCarousel: function (t, i) {
            var a, n, o, r;
            (a = i.slidesToShow.tablet ? i.slidesToShow.tablet : 1 === i.slidesToShow.desktop ? 1 : 2),
                (n = i.slidesToShow.mobile ? i.slidesToShow.mobile : 1),
                ...
                (o = {
                    ...
                    responsive: [
                        ...
                        { breakpoint: 768, settings: { slidesToShow: n, slidesToScroll: 1 } },
                    ],
                }),
                (r = e.extend({}, o, i)),
                t.slick(r);
        ...
        widgetTable: function (e) {
            ...
            t.length &&
                ...
                t.tablesorter({ cssHeader: "jet-table-header-sort", cssAsc: "jet-table-header-sort--up", cssDesc: "jet-table-header-sort--down", initWidgets: !1 });
        },
        widgetDropbar: function (t) {
            var i,
                a,
                n = t.find(".jet-dropbar"),
        ...
        widgetHorizontalTimeline: function (t) {
            ...
            "ontouchstart" in window || "ontouchend" in window
                ? o.on("touchend.jetHorTimeline", function (i) {
                ...
                : o.on("mouseenter.jetHorTimeline mouseleave.jetHorTimeline", function (i) {
                      if (!m || "mouseleave" !== i.type) {
                          m && "mouseenter" === i.type && (m = !1);
                          var a = e(this).data("item-id");
                          t.find(".elementor-repeater-item-" + a).toggleClass("is-hover");
                      }
                  }),
                j(),
                e(window).on("resize.jetHorTimeline orientationchange.jetHorTimeline", a.debounce(50, j)),
                ...
                r[0] &&
                    r.on("click.jetHorTimeline", function (t) {
                        var i = e(this).hasClass("jet-next-arrow") ? "next" : "prev",
                            ...
                            r = u[o];
                        r > c[o] && (r = c[o]),
                            "next" === i && v < y[o] && (v += r) > y[o] && (v = y[o]),
                            "prev" === i && v > 0 && (v -= r) < 0 && (v = 0),
                            v > 0 ? l.removeClass("jet-arrow-disabled") : l.addClass("jet-arrow-disabled"),
                            v === y[o] ? s.addClass("jet-arrow-disabled") : s.removeClass("jet-arrow-disabled"),
                            (w = 0 === v ? 0 : v * b[o]),
                            n.css({ transform: "translateX(" + a * w + "%)" });
                    }),
                x(),
                e(window).on("resize.jetHorTimeline orientationchange.jetHorTimeline", x),
                e(window).on("resize.jetHorTimeline orientationchange.jetHorTimeline", function (e) {
                    ...
                    var t = elementorFrontend.getCurrentDeviceMode(),
                        a = function () {
                            l.addClass("jet-arrow-disabled"),
                                s.hasClass("jet-arrow-disabled") && s.removeClass("jet-arrow-disabled"),
        ...
        widgetPieChart: function (t) {
            var i = t.find(".jet-pie-chart-container"),
                ...
                n = i.data("chart") || {},
                o = i.data("options") || {};
            (o = e.extend({}, { maintainAspectRatio: !1 }, o)),
                elementorFrontend.waypoint(
                    t,
                    function () {
                        new Chart(a, { type: "pie", data: n, options: o });
                    },
                    { offset: "bottom-in-view" }
                );
        },
    ...
    (window.jetAnimatedText = function (t, i) {
        ...
        (a.avaliableEffects = {
            ...
            (a.textChange = function () {
                ...
                s < o.length - 1 ? s++ : (s = 0),
                    (e = o.eq(s)),
                    a.hideText(t, i.effect, null, function (n) {
            ...
            (a.showText = function (t, i, n, o) {
                ...
                e("span", t).each(function () {
                    e(this).css({ width: "auto", opacity: 1, WebkitTransform: "", transform: "" }), r.push(this);
                }),
        ...
        (window.jetImagesLayout = function (t, i) {
            ...
            i = i || {};
            (a = { layoutType: "masonry", columns: 3, columnsTablet: 2, columnsMobile: 1, justifyHeight: 300 }),
                e.extend(a, i),
                        ...
                        case "justify":
                            r.each(function () {
                                var t = e(this),
                                    ...
                                    o = 100 * n,
                                    r = +i.justifyHeight * n;
                                t.css({ "flex-grow": o, "flex-basis": r });
                            });
                    }
        ...
        (window.jetScrollNavigation = function (t, i, n) {
            var o = this,
                r = e(window),
                s = e(document),
                l = (e("body"), i),
            ...
            jQuery.extend(jQuery.easing, {
                ...
                (o.init = function () {
                    o.setSectionsData(),
                        p && u.hasOwnProperty(p) && c.addClass("invert"),
                        c.on("click.jetScrollNavigation", function (t) {
                            var i = e(this).data("anchor");
                            o.onAnchorChange(i);
                        }),
                        r.on("resize.jetScrollNavigation orientationchange.jetScrollNavigation", a.debounce(50, o.onResize)),
                        r.on("load", function () {
                            o.setSectionsData();
                        }),
                        s.keydown(function (e) {
                            o.isEnabled() && (38 == e.keyCode && o.directionSwitch(e, "up"), 40 == e.keyCode && o.directionSwitch(e, "down"));
                        }),
                        o.waypointHandler(),
                        o.hijakingHandler();
                }),
                (o.setSectionsData = function () {
                    c.each(function () {
                        ...
                        n[0] &&
                            ...
                            (n[0].dataset.sectionName = i),
                            (u[i] = { selector: n, offset: Math.round(n.offset().top), height: n.outerHeight(), invert: a }));
                    });
                }),
                (o.waypointHandler = function () {
                    for (var t in u) {
                        var i = u[t].selector;
                        elementorFrontend.waypoint(
                            i,
                ...
                (o.onAnchorChange = function (t) {
                    var i,
                        a = e("[data-anchor=" + t + "]", l);
                    if (!u.hasOwnProperty(t)) return !1;
                    (i = u[t].offset - n.offset),
                        f ||
                            ((f = !0),
                            ...
                            d.animate({ scrollTop: i }, n.speed, "easeInOutCirc", function () {
                                f = !1;
                            }));
                }),
                (o.directionSwitch = function (t, i) {
                    i = i || "up";
                    var a = e("[data-anchor=" + m + "]", l).next(),
                        n = e("[data-anchor=" + m + "]", l).prev();
                    if (f) return !1;
                    "up" === i && n[0] && n.trigger("click.jetScrollNavigation"), "down" === i && a[0] && a.trigger("click.jetScrollNavigation");
                }),
                (o.hijakingHandler = function () {
                    var t = a.mobileAndTabletcheck(),
                        i = 0;
                    n.sectionSwitch &&
                        (t || document.addEventListener("wheel", o.onWheel, { passive: !1 }),
                        t &&
                            n.sectionSwitchOnMobile &&
                                    ...
                                    if (o.isEnabled()) {
                                        ...
                                        return (
                                            ...
                                            void (
                                                ...
                                                (f = u[l].offset),
                                                "up" === m && (f - w < d && (g = l), g && (p = g)),
                                                "down" === m && (f + w > d && (h = l), h && (p = h)),
                                                p && o.onAnchorChange(p))
                                            )
                                        );
                                    }
                                },
                ...
                (o.onWheel = function (t) {
                    if (o.isEnabled()) {
                        ...
                        if (
                            ...
                            (m = a.getObjectNextKey(u, i)),
                            (l = u[i].offset),
                            "up" === s && (l < p + n.offset - 10 && (c = i), c && (d = c)),
                            "down" === s && (l > p + n.offset + 10 && (m = i), m && (d = m)),
                            d)
                        ) {
                ...
                (o.scrollStop = function () {
                    d.stop(!0);
                }),
                (o.isEnabled = function () {
                    return t.is(":visible");
                }),
                (o.mobileAndTabletcheck = function () {
                    var e,
                        t = !1;
                    return (
                        (e = navigator.userAgent || navigator.vendor || window.opera),
        ...
        (window.jetSectionParallax = function (i) {
            ...
            (n.init = function () {
                ...
                n.generateLayouts(),
                    0 !== d.length && l.on("scroll.jetSectionParallax resize.jetSectionParallax", n.scrollHandler),
                    0 !== c.length && (i.on("mousemove.jetSectionParallax resize.jetSectionParallax", n.mouseMoveHandler), i.on("mouseleave.jetSectionParallax", n.mouseLeaveHandler)),
                    n.scrollUpdate();
            }),
                (n.generateEditorSettings = function (t) {
                    ...
                    return (
                        ...
                        !(!n.hasOwnProperty("jet_parallax_layout_list") || 0 === Object.keys(n).length) &&
                            ((a = n.jet_parallax_layout_list.models),
                    ...
                    e(".jet-parallax-section__layout", i).remove(),
                        e.each(r, function (t, n) {
                            var o,
                                ...
                                k = "MacIntel" == g ? " is-mac" : "";
                            if ("" === s.url && !x) return !1;
                            i.hasClass("jet-parallax-section") || i.addClass("jet-parallax-section"),
                                (o = e(
                                    ...
                                    .prependTo(i)
                                    .css({ "z-index": u }));
                            var _ = { "background-size": m, "background-position-x": p + "%", "background-position-y": h + "%" };
                            "" !== s.url && (_["background-image"] = "url(" + s.url + ")"),
                                e("> .jet-parallax-section__image", o).css(_),
                                (r = { selector: o, image: s.url, size: m, prop: f, type: w, device: y, xPos: p, yPos: h, direction: +v, fxDirection: b, speed: (l / 100) * 2 }),
                ...
                (n.scrollUpdate = function () {
                    e.each(d, function (t, i) {
                        ...
                        if (-1 === i.device.indexOf(g))
                            return n.css({ transform: "translateX(0) translateY(0)", "background-position-y": i.yPos, "background-position-x": i.xPos, filter: "none", opacity: "1" }), !1;
                        switch ((u < r - m && (p = 0), u > r + s && (p = 200), (p = parseFloat(o * p).toFixed(1)), d)) {
                            case "scroll":
                                "bgposition" === l ? n.css({ "background-position-y": "calc(" + i.yPos + "% + " + p + "px)" }) : n.css({ transform: "translateY(" + p + "px)" });
                                break;
                            case "h-scroll":
                                "bgposition" === l ? n.css({ "background-position-x": "calc(" + i.xPos + "% + " + p * c + "px)" }) : n.css({ transform: "translateX(" + p * c + "px)" });
                                break;
                            case "zoom":
                                var h = ((u - r + m) / m) * o;
                                (h += 1), n.css({ transform: "scale(" + h + ")" });
                                break;
                            case "rotate":
                                var w = p;
                                n.css({ transform: "rotateZ(" + w * c + "deg)" });
                                break;
                            case "blur":
                                var v = 0;
                                switch (f) {
                ...
                (n.mouseLeaveHandler = function (t) {
                    e.each(c, function (t, i) {
                        ...
                        switch (i.prop) {
                            case "transform3d":
                                TweenMax.to(n[0], 1.2, { x: 0, y: 0, z: 0, rotationX: 0, rotationY: 0, ease: Power2.easeOut });
                        }
                    });
                }),
                (n.mouseMoveUpdate = function () {
                    e.each(c, function (t, i) {
                        ...
                        if (-1 == i.device.indexOf(m)) return n.css({ transform: "translateX(0) translateY(0)", "background-position-x": i.xPos, "background-position-y": i.yPos }), !1;
                        switch (r) {
                            case "bgposition":
                                TweenMax.to(n[0], 1, { backgroundPositionX: "calc(" + i.xPos + "% + " + s + "px)", backgroundPositionY: "calc(" + i.yPos + "% + " + l + "px)", ease: Power2.easeOut });
                                break;
                            case "transform":
                                TweenMax.to(n[0], 1, { x: s, y: l, ease: Power2.easeOut });
                                break;
                            case "transform3d":
                                TweenMax.to(n[0], 2, { x: s, y: l, z: d, rotationX: u, rotationY: -c, ease: Power2.easeOut });
                        }
                    });
                });
        }),
        (window.jetPortfolio = function (t, i) {
            ...
            (o.init = function () {
                ...
                (o.layoutBuild = function () {
                    if (
                        (o.generateData(),
                        d.data("showItems", m ? i.perPage : "all"),
                        "justify" == i.layoutType && (h.columnWidth = ".grid-sizer"),
                        ("masonry" != i.layoutType && "justify" != i.layoutType) || (n = s.masonry(h)),
                ...
                (o.moreButtonHandler = function (t) {
                    ...
                    e.each(f, function (e, t) {
                        ...
                        s[0] && ((a = s.data("showItems")), s.data("showItems", a + n - 1)),
                        o.render(),
                        o.checkMoreButton();
                }),
                        ...
                        e.each(f, function (t, a) {
                            ...
                            a.visible
                                ? (a.selector.addClass("visible-status"),
                                  a.lightboxEnabled && o[0].setAttribute("data-elementor-lightbox-slideshow", r),
                                  anime({ targets: n[0], opacity: { value: 1, duration: 400 }, scale: { value: 1, duration: 500, easing: "easeOutExpo" }, delay: 50, elasticity: !1 }))
                                : (a.selector.addClass("hidden-status"),
                                  o[0].removeAttribute("data-elementor-lightbox-slideshow"),
                                  anime({ targets: n[0], opacity: 0, scale: 0, duration: 500, elasticity: !1 }));
                        }),
                        n && n.masonry("layout");
                });
        }),
        (window.jetTimeLine = function (t) {
            ...
            (n.onScroll = function () {
                ...
                (n.updateWindow = function () {
                    (f = !1),
                        o.css({ top: s.first().find(l).offset().top - s.first().offset().top, bottom: t.offset().top + t.outerHeight() - s.last().find(l).offset().top }),
                        c !== d && ((c = d), u, n.updateProgress());
                }),
                (n.updateProgress = function () {
                    var t = s.last().find(l).offset().top,
                        i = d - r.offset().top + m / 2;
                    t <= d + m / 2 && (i = t - r.offset().top),
                        r.css({ height: i + "px" }),
                        s.each(function () {
                            e(this).find(l).offset().top < d + 0.5 * m ? e(this).addClass("is--active") : e(this).removeClass("is--active");
                        });
                }),
                ...
                (n.animateCards = function () {
                    s.each(function () {
                        e(this).offset().top <= d + 0.9 * m && e(this).hasClass("jet-timeline-item--animated") && e(this).addClass("is--show");
                    });
                }),
                (n.init = function () {
        ...
        (window.jetScratchEffect = function (e, t, i) {
            ...
            var n,
                ...
                c = !1;
            function u(e, t) {
                return { x: (e.pageX || e.touches[0].clientX) - 0, y: (e.pageY || e.touches[0].clientY) - 0 };
            }
            function m(e) {
                (c = !0), (n = u(e));
            }
                ...
                if (c) {
                    ...
                    for (
                        var t,
                            a,
                            m = u(e),
                            f = ((t = n), (a = m), Math.sqrt(Math.pow(a.x - t.x, 2) + Math.pow(a.y - t.y, 2))),
                            p = (function (e, t) {
                        ...
                        (g = n.x + Math.sin(p) * w - 40), (h = n.y + Math.cos(p) * w - 40), (l.globalCompositeOperation = "destination-out"), l.drawImage(d, g, h, 80, 80);
                    (n = m),
                        ((function (e) {
                            (!e || e < 1) && (e = 1);
            ...
            (d.src =
                ...
                o.addEventListener("mousemove", a.debounce(5, f), !1),
                o.addEventListener("mouseup", p, !1),
                o.addEventListener("touchstart", m, !1),
                o.addEventListener("touchmove", f, !1),
