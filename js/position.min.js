        ...
        (function () {
            ...
            (I.position = {
                    ...
                    return (
                        ...
                        I.each(["my", "at"], function () {
                            var t,
                                i,
                                e = (c[this] || "").split(" ");
                            1 === e.length && (e = o.test(e[0]) ? e.concat(["center"]) : l.test(e[0]) ? ["center"].concat(e) : ["center", "center"]),
                        ...
                        1 === y.length && (y[1] = y[0]),
                        "right" === c.at[0] ? (m.left += a) : "center" === c.at[0] && (m.left += a / 2),
                        "bottom" === c.at[1] ? (m.top += g) : "center" === c.at[1] && (m.top += g / 2),
                        (d = P(b.at, a, g)),
                        (m.left += d[0]),
                        (m.top += d[1]),
                        this.each(function () {
                            ...
                            "right" === c.my[0] ? (r.left -= s) : "center" === c.my[0] && (r.left -= s / 2),
                                "bottom" === c.my[1] ? (r.top -= h) : "center" === c.my[1] && (r.top -= h / 2),
                                (r.left += p[0]),
                                (r.top += p[1]),
                                ...
                                c.using &&
                                    (t = function (t) {
                                        ...
                                        a < s && T(i + e) < a && (l.horizontal = "center"),
                                            ...
                                            x(T(i), T(e)) > x(T(o), T(n)) ? (l.important = "horizontal") : (l.important = "vertical"),
                ...
                (I.ui.position = {
                    fit: {
                        left: function (t, i) {
                            ...
                            i.collisionWidth > l
                                ? 0 < s && h <= 0
                                    ? ((e = t.left + s + i.collisionWidth - l - n), (t.left += s - e))
                                    : (t.left = 0 < h && s <= 0 ? n : h < s ? n + l - i.collisionWidth : n)
                                : 0 < s
                                ? (t.left += s)
                                : 0 < h
                                ? (t.left -= h)
                        ...
                        top: function (t, i) {
                            ...
                            i.collisionHeight > l
                                ? 0 < s && h <= 0
                                    ? ((e = t.top + s + i.collisionHeight - l - n), (t.top += s - e))
                                    : (t.top = 0 < h && s <= 0 ? n : h < s ? n + l - i.collisionHeight : n)
                                : 0 < s
                                ? (t.top += s)
                                : 0 < h
                                ? (t.top -= h)
                    ...
                    flip: {
                        left: function (t, i) {
                            var e,
                                ...
                                a = -2 * i.offset[0];
                            r < 0
                                ? ((e = t.left + c + d + a + i.collisionWidth - f - l) < 0 || e < T(r)) && (t.left += c + d + a)
                                : 0 < p && (0 < (o = t.left - i.collisionPosition.marginLeft + c + d + a - s) || T(o) < p) && (t.left += c + d + a);
                        },
                        top: function (t, i) {
                            var e,
                                o,
                                ...
                                a = -2 * i.offset[1];
                            r < 0
                                ? ((o = t.top + c + d + a + i.collisionHeight - f - l) < 0 || o < T(r)) && (t.top += c + d + a)
                                : 0 < p && (0 < (e = t.top - i.collisionPosition.marginTop + c + d + a - s) || T(e) < p) && (t.top += c + d + a);
                        },
                    },
                    flipfit: {
                        left: function () {
                ...
                (function () {
                    ...
                    l && I.extend(e, { position: "absolute", left: "-1000px", top: "-1000px" }),
                    e))
                        t.style[n] = e[n];
                    t.appendChild(f),
