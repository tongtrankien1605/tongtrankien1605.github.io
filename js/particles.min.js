    ...
    t && Object.deepExtend(m, t),
            ...
            for (var e = 0; e < m.particles.array.length; e++) {
                ...
                if (
                    (m.particles.opacity.anim.enable &&
                        (1 == t.opacity_status
                            ? (t.opacity >= m.particles.opacity.value && (t.opacity_status = !1), (t.opacity += t.vo))
                            : (t.opacity <= m.particles.opacity.anim.opacity_min && (t.opacity_status = !0), (t.opacity -= t.vo)),
                        t.opacity < 0 && (t.opacity = 0)),
                    m.particles.size.anim.enable &&
                        (1 == t.size_status
                            ? (t.radius >= m.particles.size.value && (t.size_status = !1), (t.radius += t.vs))
                            : (t.radius <= m.particles.size.anim.size_min && (t.size_status = !0), (t.radius -= t.vs)),
            ...
            if (m.interactivity.events.onhover.enable && isInArray("bubble", m.interactivity.events.onhover.mode)) {
                    ...
                    if (0 <= a && "mousemove" == m.interactivity.status) {
                        ...
                        if (m.interactivity.modes.bubble.opacity != m.particles.opacity.value)
                            if (m.interactivity.modes.bubble.opacity > m.particles.opacity.value)
                                ...
                                (r = c.opacity - (m.particles.opacity.value - m.interactivity.modes.bubble.opacity) * a) < c.opacity &&
                ...
                if (m.tmp.bubble_clicking) {
                    ...
                    l > m.interactivity.modes.bubble.duration && (m.tmp.bubble_duration_end = !0),
                        l > 2 * m.interactivity.modes.bubble.duration && ((m.tmp.bubble_clicking = !1), (m.tmp.bubble_duration_end = !1));
                }
                function v(e, t, a, i, s) {
                    if (e != t)
                        if (m.tmp.bubble_duration_end)
                            null != a && ((r = e + (e - (i - (l * (i - e)) / m.interactivity.modes.bubble.duration))), "size" == s && (c.radius_bubble = r), "opacity" == s && (c.opacity_bubble = r));
                ...
                m.tmp.bubble_clicking &&
                    (v(m.interactivity.modes.bubble.size, m.particles.size.value, c.radius_bubble, c.radius, "size"),
        ...
        (m.fn.modes.repulseParticle = function (i) {
            if (m.interactivity.events.onhover.enable && isInArray("repulse", m.interactivity.events.onhover.mode) && "mousemove" == m.interactivity.status) {
                ...
                "bounce" == m.particles.move.out_mode
                    ? (0 < c.x - i.radius && c.x + i.radius < m.canvas.w && (i.x = c.x), 0 < c.y - i.radius && c.y + i.radius < m.canvas.h && (i.y = c.y))
                    : ((i.x = c.x), (i.y = c.y));
                ...
                if ("svg" == e) {
                    ...
                    t.open("GET", m.particles.shape.image.src),
                        (t.onreadystatechange = function (e) {
                            4 == t.readyState &&
                                (200 == t.status
                                    ? ((m.tmp.source_svg = e.currentTarget.response), m.fn.vendors.checkBeforeDraw())
                                    : (console.log("Error pJS - Image not found"), (m.tmp.img_error = !0)));
                        }),
                        t.send();
                } else {
                    var a = new Image();
        ...
        (m.fn.vendors.start = function () {
            isInArray("image", m.particles.shape.type)
                ? ((m.tmp.img_type = m.particles.shape.image.src.substr(m.particles.shape.image.src.length - 3)), m.fn.vendors.loadImg(m.tmp.img_type))
